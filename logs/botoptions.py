...
async def task_manager_start(start_pego=None, start_gacha=None, start_trough=None):
    logs.gachalogs.logger.debug(f"task_manager_start initiated")
    await run_blocking(task_manager.main, start_pego, start_gacha, start_trough)
